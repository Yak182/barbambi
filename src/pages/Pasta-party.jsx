        ...
        >
            <div className={"flex flex-col items-center justify-center mx-auto mb-40"}>
                <div className={"flex flex-col items-center"}>
                    <HeaderNews title={"Thursday Pasta Party"} className={"!py-2 "}/>
                ...
                <div className={"flex flex-col items-center paragraph-styles text-lg font-bold"}>
                    ...
                    <p>Featuring our bottomless pasta party package at $69pp showcasing some of our famous dishes of
                        Vodka Pasta and a Limoncello Spritz.</p>
                    <p>With a mix of RNB tunes into house classics, it’s the perfect night to kickstart the weekend
                        early.</p>
                </div>
