			...
			<form className={"flex flex-col justify-center items-center w-full space-y-6"}>
				<div className={"flex flex-col gap-4 my-10 text-black w-full max-w-2xl mx-auto"}>
					...
					<div className={"grid gap-4"}>
						...
						<div className={""}>
							<label htmlFor="date" className="uppercase text-bar-bambi-gold italic text-sm">
								Booking Date Requested*
							</label>
							<input
								id="date"
								name="date"
								type="date"
								required
								className="w-full p-2 bg-white border border-[#ccc] outline-none uppercase placeholder-white "
							/>
						</div>

						<div className={""}>
							<label htmlFor={"time"} className={"uppercase text-bar-bambi-gold italic text-sm"}>
								start time*
							</label>
							<input
								id="start-time"
